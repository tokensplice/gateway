...
redis.call('HSET', KEYS[1],
  ...
  'RateLimitRPM', ARGV[17], 'RateLimitTPM', ARGV[18], 'DailySpendingCap', ARGV[19],
  'MonthlySpendingCap', ARGV[20], 'GroupName', ARGV[21])
redis.call('EXPIRE', KEYS[1], ARGV[22])
return 1`
	...
	return common.RDB.Eval(context.Background(), script, []string{
		...
		token.RateLimitRPM, token.RateLimitTPM, token.DailySpendingCap,
		token.MonthlySpendingCap, token.GroupName,
